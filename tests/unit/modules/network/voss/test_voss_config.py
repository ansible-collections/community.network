...
from ansible_collections.community.network.plugins.modules.network.voss import voss_config
from ansible_collections.community.network.plugins.cliconf.voss import Cliconf
...
class TestVossConfigModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.community.network.plugins.modules.network.voss.voss_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_get_connection = patch('ansible_collections.community.network.plugins.modules.network.voss.voss_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.conn = self.get_connection()
        self.conn.edit_config = MagicMock()

        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.voss.voss_config.run_commands')
