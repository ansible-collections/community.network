...
from ansible_collections.community.network.plugins.modules import pn_connection_stats_settings
...
class TestAdminServiceModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_connection_stats_settings.run_cli')
