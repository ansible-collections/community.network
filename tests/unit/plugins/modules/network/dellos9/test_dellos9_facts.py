...
from ansible_collections.community.network.plugins.modules.network.dellos9 import dellos9_facts
...
class TestDellos9Facts(TestDellos9Module):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch(
            'ansible_collections.community.network.plugins.modules.network.dellos9.dellos9_facts.run_commands')
