...
from ansible_collections.community.network.plugins.modules.network.cloudengine import ce_is_is_view
...
class TestCloudEngineLacpModule(TestCloudEngineModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.community.network.plugins.modules.network.cloudengine.ce_is_is_view.get_nc_config')
        self.get_nc_config = self.mock_get_config.start()

        self.mock_set_config = patch('ansible_collections.community.network.plugins.modules.network.cloudengine.ce_is_is_view.set_nc_config')
