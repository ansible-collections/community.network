...
from ansible_collections.community.network.plugins.modules.network.dellos6 import dellos6_facts
...
class TestDellos6Facts(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch(
            'ansible_collections.community.network.plugins.modules.network.dellos6.dellos6_facts.run_commands')
