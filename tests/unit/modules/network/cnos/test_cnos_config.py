...
from ansible_collections.community.network.plugins.modules.network.cnos import cnos_config
...
class TestCnosConfigModule(TestCnosModule):
    ...
    def setUp(self):
        self.patcher_get_config = patch('ansible_collections.community.network.plugins.modules.network.cnos.cnos_config.get_config')
        self.mock_get_config = self.patcher_get_config.start()
        self.patcher_exec_command = patch('ansible_collections.community.network.plugins.modules.network.cnos.cnos_config.load_config')
