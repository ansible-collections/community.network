...
from ansible_collections.community.network.plugins.modules import pn_ipv6security_raguard_port
...
class TestIPV6SecurityRaguardPortModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_ipv6security_raguard_port.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.community.network.plugins.modules.pn_ipv6security_raguard_port.check_cli')
