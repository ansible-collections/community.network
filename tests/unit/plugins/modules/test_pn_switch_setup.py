...
from ansible_collections.community.network.plugins.modules import pn_switch_setup
...
class TestSwitchSetupModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_switch_setup.run_cli')
