...
from ansible_collections.community.network.plugins.modules import pn_cpu_mgmt_class
...
class TestCpuMgmtClassModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_cpu_mgmt_class.run_cli')
