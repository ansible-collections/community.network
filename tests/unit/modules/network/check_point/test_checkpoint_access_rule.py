...
import pytest
from ansible_collections.community.network.tests.unit.modules.utils import set_module_args, exit_json, fail_json, AnsibleFailJson, AnsibleExitJson

from ansible.module_utils import basic
from ansible_collections.community.network.plugins.modules.network.check_point import checkpoint_access_rule
...
class TestCheckpointAccessRule(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.community.network.plugins.modules.network.check_point.checkpoint_access_rule.Connection')
        return connection_class_mock.return_value

    @pytest.fixture
    def get_access_rule_200(self, mocker):
        mock_function = mocker.patch('ansible_collections.community.network.plugins.modules.network.check_point.checkpoint_access_rule.get_access_rule')
