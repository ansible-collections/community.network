...
from ansible_collections.community.network.plugins.modules import pn_port_cos_bw
...
class TestAdminServiceModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_port_cos_bw.run_cli')
