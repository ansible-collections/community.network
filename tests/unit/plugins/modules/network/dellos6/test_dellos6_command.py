...
from ansible_collections.community.network.plugins.modules.network.dellos6 import dellos6_command
...
class TestDellos6CommandModule(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.dellos6.dellos6_command.run_commands')
