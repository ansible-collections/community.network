...
try:
    ...
    try:
        from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_gtm_pool import Parameters
        from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_gtm_pool import ModuleManager
