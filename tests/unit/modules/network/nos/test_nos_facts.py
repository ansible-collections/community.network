...
from ansible_collections.community.network.plugins.modules.network.nos import nos_facts
...
class TestNosFactsModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.nos.nos_facts.run_commands')
