...
from ansible_collections.community.network.plugins.modules import icx_banner
...
class TestICXBannerModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('ansible_collections.community.network.plugins.modules.icx_banner.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('ansible_collections.community.network.plugins.modules.icx_banner.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.community.network.plugins.modules.icx_banner.get_config')
