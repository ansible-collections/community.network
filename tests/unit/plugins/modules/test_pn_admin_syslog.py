...
from ansible_collections.community.network.plugins.modules import pn_admin_syslog
...
class TestAdminSyslogModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_admin_syslog.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.community.network.plugins.modules.pn_admin_syslog.check_cli')
