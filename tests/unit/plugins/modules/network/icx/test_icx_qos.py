...
class TestICXQosModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('ansible.modules.network.icx.icx_qos.exec_command')
        self.mock_run_commands = patch('ansible.modules.network.icx.icx_qos.run_commands')
        self.mock_get_config = patch('ansible.modules.network.icx.icx_qos.get_config')
        self.mock_load_config = patch('ansible.modules.network.icx.icx_qos.load_config')
