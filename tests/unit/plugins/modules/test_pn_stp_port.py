...
from ansible_collections.community.network.plugins.modules import pn_stp_port
...
class TestStpPortModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_stp_port.run_cli')
