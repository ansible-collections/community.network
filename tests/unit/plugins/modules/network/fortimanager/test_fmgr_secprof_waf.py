...
try:
    from ansible_collections.community.network.plugins.modules.network.fortimanager import fmgr_secprof_waf
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.community.network.plugins.modules.network.fortimanager.fmgr_secprof_waf.Connection')
    return connection_class_mock
