...
from ansible_collections.community.network.plugins.modules.network.dellos9 import dellos9_config
...
class TestDellos9ConfigModule(TestDellos9Module):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.community.network.plugins.modules.network.dellos9.dellos9_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.community.network.plugins.modules.network.dellos9.dellos9_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.dellos9.dellos9_config.run_commands')
