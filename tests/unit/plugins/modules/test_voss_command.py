...
from ansible_collections.community.network.plugins.modules import voss_command
...
class TestVossCommandModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.voss_command.run_commands')
