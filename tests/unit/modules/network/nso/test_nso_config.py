...
from ansible_collections.community.network.plugins.modules.network.nso import nso_config
...
class TestNsoConfig(nso_module.TestNsoModule):
    ...
    @patch('ansible_collections.community.network.plugins.module_utils.network.nso.nso.open_url')
