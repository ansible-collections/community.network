...
from ansible_collections.community.network.plugins.modules.network.aireos import aireos_command
...
class TestCiscoWlcCommandModule(TestCiscoWlcModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.aireos.aireos_command.run_commands')
