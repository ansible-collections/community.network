...
from ansible_collections.community.network.plugins.modules import pn_vflow_table_profile
...
class TestVflowTableProfileModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_vflow_table_profile.run_cli')
