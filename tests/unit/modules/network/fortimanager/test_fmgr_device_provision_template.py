...
try:
    from ansible_collections.community.network.plugins.modules.network.fortimanager import fmgr_device_provision_template
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.community.network.'
