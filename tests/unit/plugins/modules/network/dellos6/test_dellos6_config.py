...
from ansible_collections.community.network.plugins.modules.network.dellos6 import dellos6_config
...
class TestDellos6ConfigModule(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.community.network.plugins.modules.network.dellos6.dellos6_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.community.network.plugins.modules.network.dellos6.dellos6_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.dellos6.dellos6_config.run_commands')
