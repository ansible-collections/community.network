...
from ansible_collections.community.network.plugins.modules.network.dellos9 import dellos9_command
...
class TestDellos9CommandModule(TestDellos9Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.dellos9.dellos9_command.run_commands')
