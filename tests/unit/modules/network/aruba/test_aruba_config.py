...
from ansible_collections.community.network.plugins.modules.network.aruba import aruba_config
...
class TestArubaConfigModule(TestArubaModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.community.network.plugins.modules.network.aruba.aruba_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.community.network.plugins.modules.network.aruba.aruba_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.aruba.aruba_config.run_commands')
