...
from ansible_collections.community.network.plugins.modules.network.edgeos import edgeos_facts
...
class TestEdgeosFactsModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.edgeos.edgeos_facts.run_commands')
