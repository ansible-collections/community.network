...
from ansible_collections.community.network.plugins.modules.network.voss import voss_command
...
class TestVossCommandModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.community.network.plugins.modules.network.voss.voss_command.run_commands')
