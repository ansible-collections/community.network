...
from ansible_collections.community.network.plugins.modules import pn_dscp_map_pri_map
...
class TestCpuClassModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_dscp_map_pri_map.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.community.network.plugins.modules.pn_dscp_map_pri_map.check_cli')
