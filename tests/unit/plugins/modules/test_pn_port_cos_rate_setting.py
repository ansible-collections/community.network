...
from ansible_collections.community.network.plugins.modules import pn_port_cos_rate_setting
...
class TestPortCosRateSettingModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.community.network.plugins.modules.pn_port_cos_rate_setting.run_cli')
