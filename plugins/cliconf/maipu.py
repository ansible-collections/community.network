...
cliconf: ios
short_description: Use maipu cliconf to run command Maipu platform
description:
- This maipu plugin provides low level abstraction apis for sending and receiving CLI
  commands from Maipu network devices.
version_added: 1.0.0
options:
  config_commands:
    description:
    ...
    default: []
    vars:
    - name: ansible_maipu_config_commands
"""
