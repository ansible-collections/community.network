...
__metaclass__ = type
DOCUMENTATION = """
module: maipu_l3_interface
author: Lin fanjie
description:
- This module provides declarative management of Layer-3 interfaces on Maipu switches.
version_added: 1.0.0
notes:
...
- community.network.maipu_l3_interface
...
from ansible_collections.community.network.plugins.module_utils.network.maipu.maipu import (
    get_config,
    load_config,
)
from ansible_collections.community.network.plugins.module_utils.network.maipu.maipu import (
