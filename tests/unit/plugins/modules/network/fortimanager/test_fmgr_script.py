...
try:
    from ansible_collections.community.network.plugins.modules.network.fortimanager import fmgr_script
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.community.network.plugins.modules.network.fortimanager.fmgr_script.Connection')
    return connection_class_mock
